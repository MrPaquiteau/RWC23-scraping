<h1 align="center"> 🏉 RWC23 - WebScraping, Visualization & iOS App
...
- [Installation](#installation)
  ...
  - [4. Xcode Project Setup](#4-xcode-project-setup)
...
Additionally, this project now includes an iOS app developed in Xcode, which provides a mobile-friendly interface to view the same data. The app is designed to work seamlessly with the data generated by the web scraping tool, offering a more interactive and user-friendly experience on iOS devices.
...
- **iOS App**
  - Mobile-friendly interface for viewing match results, team details, and player statistics.
  - Interactive charts and tables for better data visualization.
  - Seamless integration with the data generated by the web scraping tool.
...
To run the iOS app, you need to have **Xcode** installed on your Mac. Follow these steps:

1. **Open the Project**:
   - Open the `RWC23App.xcodeproj` file located in the `iOS_App/RWC23App` directory.

2. **Install Dependencies**:
   - Ensure that the necessary dependencies are installed. Xcode will usually handle this automatically.
...
### 4. Run the iOS App
To view the data on an iOS device, open the Xcode project and run the app. The app will automatically load the data from the JSON files generated by the web scraping tool.
